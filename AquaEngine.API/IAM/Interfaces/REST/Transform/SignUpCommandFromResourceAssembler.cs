...
namespace AquaEngine.API.IAM.Interfaces.REST.Transform;
...
public static class SignUpCommandFromResourceAssembler
{
    ...
    {
        return new SignUpCommand(resource.Username, resource.Password, resource.FullName, resource.PhoneNumber, resource.DniNumber);
    }
}